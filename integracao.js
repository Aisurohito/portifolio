...
const PROJECTS = [
  {
    title: "Larck Studio — Portfólio",
    type: "web",
    desc: "Landing page com foco em apresentação, CTA e responsivo.",
    tech: ["HTML", "CSS", "JS"],
    link: "https://larck-studio-prot-tipo.vercel.app/",
  },
  {
  ...
  link: "#",
  video: "assets/videos/sorteio.mp4"
},
...
function renderProjects(filterType = "all") {
  ...
  items.forEach((p) => {
    ...
    const media = p.video
  ? `<video class="thumb-media" src="${escapeHtml(p.video)}" preload="metadata" muted playsinline controls></video>`
  : "";
